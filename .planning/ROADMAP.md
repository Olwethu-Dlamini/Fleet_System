...
| 8 | Testing Suite | 1/3 | In Progress|  |
...
- [x] 03-03-PLAN.md — Flutter UI: driver load picker with green glow/suggested chip, technician chips, completion flow with GPS capture
...
- [x] 05-02-PLAN.md -- FCM integration: Flutter FCM service + Android config, login token registration, backend topic subscription
- [x] 05-03-PLAN.md -- Flutter UI: notification model/provider/service, bell icon with badge, notification center screen
...
- [x] 06-02-PLAN.md — Flutter driver/technician side: models, service, provider, request screen, Add More Time button on job detail
- [x] 06-03-PLAN.md — Flutter scheduler side: approval screen with impact timeline + suggestion cards, FCM deep-link routing, provider registration
